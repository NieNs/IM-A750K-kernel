...
struct cyttsp {
	...
	u16 prev_mt_pos[CYTTSP_NUM_MT_TOUCH_ID][5];
...
void cyttsp_xy_worker(struct work_struct *work)
{
	...
	u16 curr_mt_pos[CYTTSP_NUM_TRACK_ID][5];	/* if NOT CYTTSP_USE_TRACKING_ID then only uses CYTTSP_NUM_MT_TOUCH_ID positions */
